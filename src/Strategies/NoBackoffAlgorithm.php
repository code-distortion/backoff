...
/**
 * A class that provides a "no backoff" strategy - it returns false straight away to stop.
 */
class NoBackoffStrategy extends BaseBackoffStrategy implements BackoffStrategyInterface
{
