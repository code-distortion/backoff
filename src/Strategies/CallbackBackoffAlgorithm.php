...
/**
 * A class that provides a custom (callback-based) backoff strategy.
 */
class CallbackBackoffStrategy extends BaseBackoffStrategy implements BackoffStrategyInterface
{
